...
int main()
{
    ...
    LPWSTR fileName = (LPWSTR)L"D:\\University\\OS09_01.txt";

    printFileTxt(fileName);

    insRowFileTxt(fileName, (LPWSTR)L"0. Zero", 0);
    insRowFileTxt(fileName, (LPWSTR)L"-1. Minus one", -1);
    insRowFileTxt(fileName, (LPWSTR)L"4. Four Four", 4);
    insRowFileTxt(fileName, (LPWSTR)L"7. Se7ven Se7ven", 7);
